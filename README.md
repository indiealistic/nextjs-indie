# Next.js Indie Starter 🚀

Just another Next.js starter with more features for Next.js.

Use Tailwind CSS, ESLint, Prettier & absolute imports instantly.
Easily extendable zero-config template for pros and beginners.

Check out the [Demo website.](https://nextjs-indie.vercel.app/)

## Table of Contents

- [Next.js Indie Starter 🚀](#nextjs-indie-starter-)
